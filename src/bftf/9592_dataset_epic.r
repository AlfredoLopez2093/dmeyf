...
##Deriva del v951
## 1)Quito variables
## mrentabilidad,mrentabilidad_annual,mcomisiones,mactivos_margen,mpasivos_margen,ccomisiones_otras
## mcomisiones_otras,Visa_Finiciomora
## 2)Activo palanca de feature engineering y creo nuevas variables considerando las 10 mas importantes
## 3)Activo palanca de lag1
## 4)Activo palanca de canaritos
...
palancas$version  <- "v9592"   #Muy importante, ir cambiando la version

palancas$variablesdrift  <- c("mrentabilidad","mrentabilidad_annual","mcomisiones","mactivos_margen",
                              "mpasivos_margen","ccomisiones_otras","mcomisiones_otras","Visa_Finiciomora")   #aqui van las columnas que se quieren eliminar
...
AgregarVariables  <- function( dataset )
{
  ...
  dataset[ , ctrxquarter_mcajaahorro         := ctrx_quarter  / mcaja_ahorro ]
  dataset[ , ctrxquarter_mtarjvisacons         := ctrx_quarter  / mtarjeta_visa_consumo ]
  dataset[ , ctrxquarter_mdescpreacord        := ctrx_quarter  / mdescubierto_preacordado ]
  dataset[ , ctrxquarter_mctacte        := ctrx_quarter  / mcuenta_corriente ]
  dataset[ , ctrxquarter_mctasaldo        := ctrx_quarter  / mcuentas_saldo ]
  dataset[ , ctrxquarter_visadelinq        := ctrx_quarter  / Visa_delinquency ]
  dataset[ , ctrxquarter_cpayrolltrx        := ctrx_quarter  / cpayroll_trx ]
  dataset[ , ctrxquarter_mprestpers        := ctrx_quarter  / mprestamos_personales ]

  
  dataset[ , visastatus_ctrxquarter        := Visa_status  / ctrx_quarter ]
  dataset[ , visastatus_mcajaahorro        := Visa_status  / mcaja_ahorro ]
  dataset[ , visastatus_mtarjvisacons        := Visa_status  / mtarjeta_visa_consumo ]
  dataset[ , visastatus_mdescpreacord        := Visa_status  / mdescubierto_preacordado ]
  dataset[ , visastatus_mctacte       := Visa_status  / mcuenta_corriente ]
  dataset[ , visastatus_mctasaldo        := Visa_status  / mcuentas_saldo ]
  dataset[ , visastatus_visadelinq        := Visa_status  / Visa_delinquency ]
  dataset[ , visastatus_cpayrolltrx         := Visa_status  / cpayroll_trx ]
  dataset[ , visastatus_mprestpers         := Visa_status  / mprestamos_personales ]
  
  
  dataset[ , mcajaahorro_ctrxquarter        := mcaja_ahorro  / ctrx_quarter ]
  dataset[ , mcajaahorro_visastatus        := mcaja_ahorro  / Visa_status ]
  dataset[ , mcajaahorro_mtarjvisacons        := mcaja_ahorro  / mtarjeta_visa_consumo ]
  dataset[ , mcajaahorro_mdescpreacord        := mcaja_ahorro  / mdescubierto_preacordado ]
  dataset[ , mcajaahorro_mctacte       := mcaja_ahorro  / mcuenta_corriente ]
  dataset[ , mcajaahorro_mctasaldo        := mcaja_ahorro  / mcuentas_saldo ]
  dataset[ , mcajaahorro_visadelinq        := mcaja_ahorro  / Visa_delinquency ]
  dataset[ , mcajaahorro_cpayrolltrx         := mcaja_ahorro  / cpayroll_trx ]
  dataset[ , mcajaahorro_mprestpers         := mcaja_ahorro  / mprestamos_personales ]
  
  dataset[ , mtarjvisacons_ctrxquarter        := mtarjeta_visa_consumo  / ctrx_quarter ]
  dataset[ , mtarjvisacons_visastatus        := mtarjeta_visa_consumo  / Visa_status ]
  dataset[ , mtarjvisacons_mcajaahorro        := mtarjeta_visa_consumo  / mcaja_ahorro ]
  dataset[ , mtarjvisacons_mdescpreacord        := mtarjeta_visa_consumo  / mdescubierto_preacordado ]
  dataset[ , mtarjvisacons_mctacte       := mtarjeta_visa_consumo  / mcuenta_corriente ]
  dataset[ , mtarjvisacons_mctasaldo        := mtarjeta_visa_consumo  / mcuentas_saldo ]
  dataset[ , mtarjvisacons_visadelinq        := mtarjeta_visa_consumo  / Visa_delinquency ]
  dataset[ , mtarjvisacons_cpayrolltrx         := mtarjeta_visa_consumo  / cpayroll_trx ]
  dataset[ , mtarjvisacons_mprestpers         := mtarjeta_visa_consumo  / mprestamos_personales ]
  
  dataset[ , mdescpreacord_ctrxquarter        := mdescubierto_preacordado  / ctrx_quarter ]
  dataset[ , mdescpreacord_visastatus        := mdescubierto_preacordado  / Visa_status ]
  dataset[ , mdescpreacord_mcajaahorro        := mdescubierto_preacordado  / mcaja_ahorro ]
  dataset[ , mdescpreacord_mtarjvisacons        := mdescubierto_preacordado  / mtarjeta_visa_consumo ]
  dataset[ , mdescpreacord_mctacte       := mdescubierto_preacordado  / mcuenta_corriente ]
  dataset[ , mdescpreacord_mctasaldo        := mdescubierto_preacordado  / mcuentas_saldo ]
  dataset[ , mdescpreacord_visadelinq        := mdescubierto_preacordado  / Visa_delinquency ]
  dataset[ , mdescpreacord_cpayrolltrx         := mdescubierto_preacordado  / cpayroll_trx ]
  dataset[ , mdescpreacord_mprestpers         := mdescubierto_preacordado  / mprestamos_personales ]
  
  dataset[ , mctacte_ctrxquarter        := mcuenta_corriente  / ctrx_quarter ]
  dataset[ , mctacte_visastatus        := mcuenta_corriente  / Visa_status ]
  dataset[ , mctacte_mcajaahorro        := mcuenta_corriente  / mcaja_ahorro ]
  dataset[ , mctacte_mtarjvisacons        := mcuenta_corriente  / mtarjeta_visa_consumo ]
  dataset[ , mctacte_mdescpreacord        := mcuenta_corriente  / mdescubierto_preacordado ]
  dataset[ , mctacte_mctasaldo        := mcuenta_corriente  / mcuentas_saldo ]
  dataset[ , mctacte_visadelinq        := mcuenta_corriente  / Visa_delinquency ]
  dataset[ , mctacte_cpayrolltrx        := mcuenta_corriente  / cpayroll_trx ]
  dataset[ , mctacte_mprestpers        := mcuenta_corriente  / mprestamos_personales ]
  
  dataset[ , mctasaldo_ctrxquarter        := mcuentas_saldo  / ctrx_quarter ]
  dataset[ , mctasaldo_visastatus        := mcuentas_saldo  / Visa_status ]
  dataset[ , mctasaldo_mcajaahorro        := mcuentas_saldo  / mcaja_ahorro ]
  dataset[ , mctasaldo_mtarjvisacons        := mcuentas_saldo  / mtarjeta_visa_consumo ]
  dataset[ , mctasaldo_mdescpreacord        := mcuentas_saldo  / mdescubierto_preacordado ]
  dataset[ , mctasaldo_mctacte        := mcuentas_saldo  / mcuenta_corriente ]
  dataset[ , mctasaldo_visadelinq        := mcuentas_saldo  / Visa_delinquency ]
  dataset[ , mctasaldo_cpayrolltrx        := mcuentas_saldo  / cpayroll_trx ]
  dataset[ , mctasaldo_mprestpers        := mcuentas_saldo  / mprestamos_personales ]
  
  dataset[ , visadelinq_ctrxquarter        := Visa_delinquency  / ctrx_quarter ]
  dataset[ , visadelinq_visastatus        := Visa_delinquency  / Visa_status ]
  dataset[ , visadelinq_mcajaahorro        := Visa_delinquency  / mcaja_ahorro ]
  dataset[ , visadelinq_mtarjvisacons        := Visa_delinquency  / mtarjeta_visa_consumo ]
  dataset[ , visadelinq_mdescpreacord        := Visa_delinquency  / mdescubierto_preacordado ]
  dataset[ , visadelinq_mctacte        := Visa_delinquency  / mcuenta_corriente ]
  dataset[ , visadelinq_mctasaldo        := Visa_delinquency  / mcuentas_saldo ]
  dataset[ , visadelinq_cpayrolltrx        := Visa_delinquency  / cpayroll_trx ]
  dataset[ , visadelinq_mprestpers        := Visa_delinquency  / mprestamos_personales ]
  
  dataset[ , cpayrolltrx_ctrxquarter        := cpayroll_trx  / ctrx_quarter ]
  dataset[ , cpayrolltrx_visastatus        := cpayroll_trx  / Visa_status ]
  dataset[ , cpayrolltrx_mcajaahorro        := cpayroll_trx  / mcaja_ahorro ]
  dataset[ , cpayrolltrx_mtarjvisacons        := cpayroll_trx  / mtarjeta_visa_consumo ]
  dataset[ , cpayrolltrx_mdescpreacord        := cpayroll_trx  / mdescubierto_preacordado ]
  dataset[ , cpayrolltrx_mctacte         := cpayroll_trx  / mcuenta_corriente ]
  dataset[ , cpayrolltrx_mctasaldo        := cpayroll_trx  / mcuentas_saldo ]
  dataset[ , cpayrolltrx_visadelinq        := cpayroll_trx  / Visa_delinquency ]
  dataset[ , cpayrolltrx_mprestpers        := cpayroll_trx  / mprestamos_personales ]
  
  dataset[ , mprestpers_ctrxquarter        := mprestamos_personales  / ctrx_quarter ]
  dataset[ , mprestpers_visastatus        := mprestamos_personales  / Visa_status ]
  dataset[ , mprestpers_mcajaahorro        := mprestamos_personales  / mcaja_ahorro ]
  dataset[ , mprestpers_mtarjvisacons        := mprestamos_personales  / mtarjeta_visa_consumo ]
  dataset[ , mprestpers_mdescpreacord        := mprestamos_personales  / mdescubierto_preacordado ]
  dataset[ , mprestpers_mctacte         := mprestamos_personales  / mcuenta_corriente ]
  dataset[ , mprestpers_mctasaldo        := mprestamos_personales  / mcuentas_saldo ]
  dataset[ , mprestpers_visadelinq        := mprestamos_personales  / Visa_delinquency ]
  dataset[ , mprestpers_cpayrolltrx        := mprestamos_personales  / cpayroll_trx ]
