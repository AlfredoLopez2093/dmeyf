...
#Alfredo
#Modifico meses de entrenamiento, quito los siguientes meses: 201903,201910,202002, 202004, 202005, 202009
...
karch_dataset    <- "./datasets/dataset_epic_v9592.csv.gz"
...
ktrain_meses_malos  <- c(201903,201910,202002,202004,202005,202006,202009)  #meses que quiero excluir del entrenamiento
...
campos_malos  <- c("mrentabilidad","mrentabilidad_annual","mcomisiones","mactivos_margen",
                   "mpasivos_margen","ccomisiones_otras","mcomisiones_otras","Visa_Finiciomora")   #aqui se deben cargar todos los campos culpables del Data Drifting
