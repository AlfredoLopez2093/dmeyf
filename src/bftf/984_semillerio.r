...
kscript         <- "984_epic"
karch_dataset   <- "./datasets/dataset_epic_v954.csv.gz"  #el dataset que voy a utilizar
...
param_ganadores  <- list( "learning_rate"= 0.0299708756191842, 
                          "feature_fraction"= 0.948382064583665,
                          "min_data_in_leaf"= 2101,
                          "num_leaves"= 385,
                          "num_iterations"= 541,
                          "ratio_corte"= 0.0368515310520282
                        )
