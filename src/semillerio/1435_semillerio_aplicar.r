...
karch_dataset  <- "./datasets/dataset_epic_v9593.csv.gz"
ksalida  <- "semillerio1435" 
...
x  <- list()
x$gleaf_size   <- 40.2612261333503 
x$gnum_leaves  <- 0.310525432410573  
x$learning_rate <-  0.196865105300704
x$feature_fraction <- 0.58599198246717   
x$num_iterations  <- 338 
...
for( semilla in  ksemillas)
{
  ...
  if(  isemilla %% 5 == 0 )  #imprimo cada 5 semillas
  {
    ...
    if (isemilla == 200 )
    {
      for(  corte  in seq( 8000, 15000, 400) ) #imprimo cortes en 8000, 8400, 8800, ..., 14400 y 14800
      {
